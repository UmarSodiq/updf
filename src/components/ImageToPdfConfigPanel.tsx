...
import { Settings, Image as ImageIcon, ArrowRight, Trash2, GripVertical, Plus, UploadCloud } from 'lucide-react';
...
export const ImageToPdfConfigPanel: React.FC<ImageToPdfConfigPanelProps> = ({ 
  files, 
  onStart, 
  onCancel, 
  onFilesUpdate,
  ...
  const t = translations[lang]?.tools.img2pdf || translations.id.tools.img2pdf;
  ...
  return (
    ...
    >
      ...
      <div className="p-8">
        ...
        >
          {files.map((file, idx) => (
            ...
            >
              ...
              <ImageIcon className="w-6 h-6 text-blue-600 dark:text-blue-400 shrink-0" />
              ...
              <button 
                ...
                title={lang === 'id' ? 'Hapus gambar' : 'Remove image'}
        ...
        {/* Prominent Add Image Dropzone / Button */}
        <button
          type="button"
          onClick={() => fileInputRef.current?.click()}
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          >
            {t.btnConvert.replace('{count}', files.length.toString())}
